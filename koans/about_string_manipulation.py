...
class AboutStringManipulation(Koan):
    ...
    def test_use_format_to_interpolate_variables(self):
        ...
        # I used the following documentation for the following question below 
    ...
    def test_formatted_values_can_be_shown_in_any_order_or_be_repeated(self):
        ...
        #You use the values from 1 and 2 from the string 

    def test_any_python_expression_may_be_interpolated(self):
        import math # import a standard python module with math functions

        # I googled the square root of 5 and rounded it four decimal places afterwards 
        # https://www.google.com/search?q=whats+the+square+root+of+5&oq=whats+the+square+root+of+5&aqs=chrome..69i57j6j0i512l8.5393j1j7&sourceid=chrome&ie=UTF-8
        decimal_places = 4
    ...
    # I used the following documentation for the question below 
    ...
    #Translated words into a string 
    ...
    def test_strings_can_be_split_with_different_patterns(self):
        ...
        # Used this documentation for escaping sequence Interpretation 
    ...
    # Joined the words in phrase without the strings of each word
