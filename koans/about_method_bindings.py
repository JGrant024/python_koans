...
class AboutMethodBindings(Koan):
    ...
    def test_setting_attributes_on_an_unbound_function(self):
         # Setting a cherries attribute to function and then called it.
        function.cherries = 3
    ...
    def test_get_descriptor_resolves_attribute_binding(self):
        ...
        # https://docs.python.org/3/library/inspect.html reviewed the following documentation for the question above for reference
