...
class AboutNone(Koan):
    ...
    def test_what_exception_do_you_get_when_calling_nonexistent_methods(self):
        ...
        # Documentation on AttributeErrors

        # https://www.geeksforgeeks.org/python-attributeerror/#:~:text=One%20of%20the%20error%20in,another%20value%20to%20that%20variable.

        # What message was attached to the exception?
        # (HINT: replace __ with part of the error message.)
        self.assertRegexpMatches(
            ex2.args[0], "object has no attribute 'some_method_none_does_not_know_about'")
