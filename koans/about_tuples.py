...
# Used the following documentation to review examples of Tuples
...
class AboutTuples(Koan):
    ...
    #https://www.geeksforgeeks.org/python-tuples/ used this documentation for futher review of tuples 
