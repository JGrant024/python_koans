...
#There can only be one name instead of reapeated names. Made a list of just the names thats not being repeated in curly braces.
class AboutSets(Koan):
    ...
    #Defined set and turned each number into a string 
    ...
    # ------------------------------------------------------------------
        #The answers are defined by the list of names below. Sorting the names based on the categories that the names are located in, Scotsman or Warriors. 
